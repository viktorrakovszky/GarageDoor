...
declare const GenerateRequestSchema: z.ZodObject<{
    ...
    context: z.ZodOptional<z.ZodArray<z.ZodObject<{
        ...
        metadata: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>; /** The text of the message. */
    }, "strip", z.ZodTypeAny, {
        content: ({
            text: string;
            media?: undefined;
...
export { type CandidateData, type CandidateError, CandidateErrorSchema, CandidateSchema, type CustomPart, CustomPartSchema, type DataPart, DataPartSchema, type GenerateRequest, type GenerateRequestData, GenerateRequestSchema, type GenerateResponseChunkData, GenerateResponseChunkSchema, type GenerateResponseData, GenerateResponseSchema, GenerationCommonConfigSchema, type GenerationUsage, GenerationUsageSchema, type MediaPart, MediaPartSchema, type MessageData, MessageSchema, type ModelAction, type ModelArgument, type ModelInfo, ModelInfoSchema, type ModelMiddleware, type ModelReference, type OutputConfig, type Part, PartSchema, type Role, RoleSchema, type TextPart, TextPartSchema, type ToolDefinition, ToolDefinitionSchema, type ToolRequestPart, ToolRequestPartSchema, type ToolResponsePart, ToolResponsePartSchema, defineModel, getBasicUsageStats, modelRef };
