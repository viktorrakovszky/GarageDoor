...
type PromptGenerateOptions<V = unknown, CustomOptions extends z.ZodTypeAny = z.ZodTypeAny> = Omit<GenerateOptions<z.ZodTypeAny, CustomOptions>, 'prompt' | 'model'> & {
...
declare class DotpromptRef<Variables = unknown> {
     ...
     * @returns the model response as a promise of `GenerateResponse`.
     */
    generate<CustomOptions extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny>(opt: PromptGenerateOptions<Variables, CustomOptions>): Promise<GenerateResponse<z.infer<O>>>;
    /**
     * Renders the prompt template based on user input.
     *
     * @param opt Options for the prompt template, including user input variables and custom model configuration options.
     * @returns a `GenerateOptions` object to be used with the `generate()` function from @genkit-ai/ai.
     */
    render<CustomOptions extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny>(opt: PromptGenerateOptions<Variables, CustomOptions>): Promise<GenerateOptions<z.ZodTypeAny, O>>;
}
/**
 ...
 */
declare function defineDotprompt<I extends z.ZodTypeAny = z.ZodTypeAny, CustomOptions extends z.ZodTypeAny = z.ZodTypeAny>(options: PromptMetadata<I, CustomOptions>, template: string): Dotprompt<z.infer<I>>;
